...
#define regs_s user_regs
    ...
    // Attach dengan retry otomatis (max 3x, delay 50ms antar retry)
    bool ptraceAttachWithRetry(pid_t pid, int maxRetries = 3);
    ...
    uintptr_t ptraceRemoteCall(pid_t pid, uintptr_t addr, uintptr_t* argv, size_t argc,
                               uintptr_t retAddr = 0);
